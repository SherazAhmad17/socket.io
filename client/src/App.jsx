          ...
          <div className="bg-white rounded-xl shadow-lg max-w-md p-6">
            ...
            <form onSubmit={handleNameSubmit} className="mt-4">
              <input
                ...
                className="w-full border border-gray-200 rounded-md px-3 py-2 outline-red-500 placeholder-gray-400"
                placeholder="Your name (e.g. Sheraz Ahmad)"
              />
              <button
                type="submit"
                className="block ml-auto mt-3 px-4 py-1.5 rounded-full bg-red-500 text-white font-medium cursor-pointer"
              >
                Continue
              </button>
            </form>
      ...
      {!showNamePopup && (
        <div className="w-full max-w-2xl h-[90vh] bg-white rounded-xl shadow-md flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
            <div className="h-10 w-10 rounded-full bg-[#a9210f] flex items-center justify-center text-white font-semibold">
              R
            </div>
                ...
                >
                  <div
                    className={`max-w-[78%] p-3 my-2 rounded-[18px] text-sm leading-5 shadow-sm ${
                      mine
                        ? "bg-[#f8c6c6] text-[#303030] rounded-br-2xl"
          ...
          <div className="px-4 py-3 border-t border-gray-200 bg-white">
            <div className="flex items-center justify-between gap-4 border border-gray-200 rounded-full">
              ...
              <button
                onClick={sendMessage}
                className="bg-red-500 text-white px-4 py-2 mr-2 rounded-full text-sm font-medium cursor-pointer"
              >
                Send
              </button>
            </div>
